let chalk,pluralize,dedent,error,warning;_ab9‍.x([["default",()=>runtimeError]]);_ab9‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_ab9‍.w("pluralize",[["default",["pluralize"],function(v){pluralize=v}]]);_ab9‍.w("ts-dedent",[["default",["dedent"],function(v){dedent=v}]]);_ab9‍.w("../../components/icons",[["error",["error"],function(v){error=v}],["warning",["warning"],function(v){warning=v}]]);
